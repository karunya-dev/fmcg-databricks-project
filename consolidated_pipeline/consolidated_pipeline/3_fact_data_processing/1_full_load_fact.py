...
base_path = f's3://barsports-dp/{data_source}'
...
# DBTITLE 1,Gold Table Merge (Fix Multiple Source Row Error)
# Ensure unique keys for merge
merge_keys = ["date", "order_id", "product_code", "customer_code"]
df_gold = df_gold.dropDuplicates(merge_keys)
